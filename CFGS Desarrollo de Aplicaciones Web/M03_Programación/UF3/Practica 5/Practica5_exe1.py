...
def guardar_diccionario(nombreFichero, diccionario):
    ...
    with open(os.path.join("Archivos", nombreFichero + ".txt"), "w") as archivo:
        for item in diccionario.items():
            ...
            # Si es una tupla hacemos lo mismo que con la lista
    ...
    try:
        with open(os.path.join("Archivos", nombreFichero), "r") as archivo:
            ...
            if "" in recover:
                recover.remove("")
            dictRecover = {}
            # Le añado la variable dictlen para que se salte todos los valores que he recuperado del diccionario
            dictlen = 0
                ...
                if dictlen > 0:
                    ...
                    if recover[i] == "key_type=int":
                        ...
                        if recover[i] == "value_type=int":
                            ...
                            # Le pasamos la lista que estamos recorriendo a partir del siguiente valor al value_type = list y montamos la lista
                        ...
                        # Le pasamos la lista que estamos recorriendo a partir del siguiente valor al value_type = tupla y montamos la tupla
                        ...
                        # Le pasamos la lista que estamos recorriendo a partir del siguiente valor al value_type = dict y montamos el dict repitiendo los procesos anteriores
                            ...
                            for j in range(len(listDictRecover)):
                                if listDictRecover[j] == "key_type=int":
                                    ...
                                    elif listDictRecover[j] == "value_type=list":
                                        listaRecover = []
                                        flagList = False
                                        
                                        for k in listDictRecover[j + 1:]:
                                            if k == "list":
                                                flagList = True
                                            ...
                                            if not flagList:
                                                ...
                                                elif k == "value_type=str":
                                                    value2 = "str"
                                                    
                                                else:
                                                    if value2 == "int":
                                                        listaRecover.append(int(k))
                                                        
                                                    elif value2 == "str":
                                                        listaRecover.append(str(k))
                                    ...
                                    elif listDictRecover[j] == "value_type=tuple":
                                        tupleRecover = []
                                        flagTuple = False
                                        ...
                                        for k in listDictRecover[j + 1:]:
                                            ...
                                            if not flagTuple:
                                                if k == "value_type=int":
                                                    ...
                                                    if value2 == "int":
                                                        tupleRecover.append(int(k))
                                                        
                                                    elif value2 == "str":
                                                        tupleRecover.append(str(k))
                                                        
                                        value2 = tuple(tupleRecover)
                                        dictRecover2[key2] = value2
                                        flagKey2 = True
                                        dictlen += 4
        ...
        print("ERROR: El documento que intentas abrir no existe.")


# Ejemplos de uso
# guardar_diccionario("dict_clients", dict_clients)
# print(cargar_diccionario("compra_client.txt"))