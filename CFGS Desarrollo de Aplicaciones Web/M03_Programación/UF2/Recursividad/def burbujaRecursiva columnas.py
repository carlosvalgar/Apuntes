def burbujaRecursiva(lista, pasadas = 0, comparaciones = 0, numLista = 0):
    ...
    if lista[comparaciones][numLista] > lista[comparaciones + 1][numLista]:
        lista[comparaciones][numLista], lista[comparaciones + 1][numLista] = lista[comparaciones + 1][numLista], lista[comparaciones][numLista]
